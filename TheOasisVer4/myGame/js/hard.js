...
var hardState = {
    ...
    rock3 = game.add.sprite(game.rnd.integerInRange(100, 500), game.rnd.integerInRange(100, 500), 'rock');
    rock3.anchor.setTo(0.5, 0.5);
    rock3.scale.setTo(1,1);
    ...
    game.time.events.loop(Phaser.Timer.SECOND * 12, this.createEnergy, this);

    //create the player
    player = game.add.sprite(300,100, 'player');
    ...
    water_label = game.add.text(520, 520, 'Get water here', {font: '24px', fill: '#DA0404'});
    water_label.stroke = '#000000';
    water_label.strokeThickness = 4;
    water_label.anchor.setTo(0.5, 0.5);

    drop_label = game.add.text(90, 80, 'Refill water here', {font: '24px', fill: '#DA0404'});
    ...
    menu_label = game.add.text(300, 300, 'Back to TitleScreen', {font: '32px', fill: '#3399FF'});
...
update: function() {
    ...
    game.physics.arcade.collide(player, rock3);
...
createEnemy: function(){
    enemy = enemies.create(game.rnd.integerInRange(20, 600), 600, 'enemy');
    enemy.anchor.setTo(0.5,0.5);
    enemy.scale.setTo(2,2);
    enemy.enableBody = true;
    game.physics.arcade.enable(enemy);
    game.physics.arcade.moveToXY(enemy, 0, 0, game.rnd.integerInRange(40, 70));
