...
var level2State = {
    ...
    //level counter
    leveltext1 = game.add.text(300, 30, 'Time for the Level: 90', { font: "24px", fill: "#000"});
    ...
    menu_label = game.add.text(300, 300, 'Back to TitleScreen', {font: '32px', fill: '#000'});
    menu_label.anchor.setTo(0.5, 0.5);
    menu_label.inputEnabled = true;
    menu_label.events.onInputDown.add(this.backtotitle, this);
    restart_label = game.add.text(300, 250, 'Restart', {font: '32px', fill: '#000'});
